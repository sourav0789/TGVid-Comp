...
async def Handle_StartMsg(bot:Client, msg:Message):
    ...
    if msg.chat.type == enums.ChatType.SUPERGROUP and not await db.is_user_exist(msg.from_user.id):
        ...
        btn = [
            ...
            [InlineKeyboardButton(text='💻 Dᴇᴠᴇʟᴏᴘᴇʀ', url='https://t.me/Sourav00876')]
        ]
        ...
        btn = [
            ...
            [InlineKeyboardButton(text='📢 Uᴘᴅᴀᴛᴇs', url='https://t.me/backupmoviezone'), InlineKeyboardButton(text='💻 Dᴇᴠᴇʟᴏᴘᴇʀ', url='https://t.me/Sourav00876')]
        ]
